...
def main(args):
    ...
    samples = decoder.forward_decoder(samples / 0.18215)  # do I need this divisive factor?
    samples = samples.unpatchify(samples)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tae", type=str, choices=["ema", "mse"], default="mse")
